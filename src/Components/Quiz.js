...
const quizData = [
  ...
  answer: "A",
    ...
    {
      category: "Numbers",
      question: ( <center> What Number is this? <br /> {<img src="./Images/Numbers/0.jpg" alt="Sign for A" style={{ width: "60%" }} />} </center>),
      options: ["1", "0"],
      answer: "0",
    },
    {
      category:  "Numbers",
     question: ( <center> What Number is this? <br /> {<img src="./Images/Numbers/1.jpg" alt="Sign for A" style={{ width: "60%" }} />} </center>),
      options: ["0", "1"],
      answer: "1",
    },
    {
      category:  "Numbers",
     question: ( <center> What Number is this? <br /> {<img src="./Images/Numbers/2.jpg" alt="Sign for A" style={{ width: "60%" }} />} </center>),
      options: ["2", "7"],
      answer: "2",
    },
    {
      category: "Numbers",
      question: ( <center> What Number is this? <br /> {<img src="./Images/Numbers/3.jpg" alt="Sign for A" style={{ width: "60%" }} />} </center>),
      options: ["3", "8"],
      answer: "3",
    },
    {
      category: "Numbers",
      question: ( <center> What Number is this? <br /> {<img src="./Images/Numbers/4.jpg" alt="Sign for A" style={{ width: "60%" }} />} </center>),
      options: ["2", "4"],
      answer: "4",
    },
    {
      category:  "Numbers",
      question: ( <center> What Number is this? <br /> {<img src="./Images/Numbers/5.jpg" alt="Sign for A" style={{ width: "60%" }} />} </center>),
      options: ["5", "9"],
      answer: "5",
    },
    {
      category:  "Numbers",
      question: ( <center> What Number is this? <br /> {<img src="./Images/Numbers/6.jpg" alt="Sign for A" style={{ width: "60%" }} />} </center>),
      options: ["6", "10"],
      answer: "6",
    },
    {
      category:  "Numbers",
      question: ( <center> What Number is this? <br /> {<img src="./Images/Numbers/7.jpg" alt="Sign for A" style={{ width: "60%" }} />} </center>),
      options: ["3", "7"],
      answer: "7",
    },
    {
      category:  "Numbers",
      question: ( <center> What Number is this? <br /> {<img src="./Images/Numbers/8.jpg" alt="Sign for A" style={{ width: "60%" }} />} </center>),
      options: ["8", "4"],
      answer: "8",
    },
    {
      category:  "Numbers",
      question: ( <center> What Number is this? <br /> {<img src="./Images/Numbers/9.jpg" alt="Sign for A" style={{ width: "60%" }} />} </center>),
      options: ["6", "9"],
      answer: "9",
    },
